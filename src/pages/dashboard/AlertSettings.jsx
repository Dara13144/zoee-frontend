      ...
      <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-brand-500/30 bg-dark-card space-y-4 shadow-xl">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            disabled={testing}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-brand-600 to-accent-fuchsia hover:brightness-110 shadow-lg transition-all shrink-0"
          >
            <Send className="w-3.5 h-3.5" />
            {testing ? 'Sending...' : 'Trigger Test Alert'}
          </button>
        </div>
